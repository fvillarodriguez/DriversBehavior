...
\end{itemize}
El \texttt{manifest.json} central mantiene progreso, bloques completados, cach\'es disponibles y errores. Si una corrida falla a mitad de camino, la siguiente ejecuci\'on puede reanudar desde el checkpoint y reutilizar tuning/SMOTE ya calculados; esto est\'a cubierto por \texttt{test\_preview\_recalibration\_checkpoint\_detects\_resumable\_manifest} y \texttt{test\_recalibration\_experiments\_resume\_from\_failed\_checkpoint}.
