...
Build Date UTC : 13 November 2025 00:46:02
Last edit: 16 October 2025
-->
<!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="navbar-light navbar-expand-md bs-sidebar hidden-print affix" role="complementary">
    ...
    <div id="toc-collapse" class="navbar-collapse collapse card bg-secondary toc-scroll toc">
        <ul class="nav flex-column bs-sidenav">
            ...
            <li class="nav-item main"><a href="#sumo_-_latest_release_version_1250">SUMO - Latest Release (Version 1.25.0)</a></li>
...
<h1 id="sumo_-_latest_release_version_1250">SUMO - Latest Release (Version 1.25.0)<a class="headerlink" href="#sumo_-_latest_release_version_1250" title="Permanent link">#</a></h1>
<p><strong>Release date:</strong> 13.11.2025</p>
...
<ul>
<li>64-bit installer: <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-win64-1.25.0.msi">sumo-win64-1.25.0.msi</a><?php getInfo("sumo-win64-1.25.0.msi","r",false);?></li>
<li>64-bit zip: <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-win64-1.25.0.zip">sumo-win64-1.25.0.zip</a><?php getInfo("sumo-win64-1.25.0.zip","r",false);?></li>
<li>64-bit installer with all extras (contains GPL code): <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-win64extra-1.25.0.msi">sumo-win64extra-1.25.0.msi</a><?php getInfo("sumo-win64extra-1.25.0.msi","r",false);?></li>
<li>64-bit zip with all extras (contains GPL code): <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-win64extra-1.25.0.zip">sumo-win64extra-1.25.0.zip</a><?php getInfo("sumo-win64extra-1.25.0.zip","r",false);?></li>
</ul>
...
<ul><li>Windows binaries: <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-game-win64-1.25.0.zip">sumo-game-win64-1.25.0.zip</a><?php getInfo("sumo-game-win64-1.25.0.zip","r",false);?></li></ul>
...
<span class="n">yum</span><span class="w"> </span><span class="n">install</span><span class="w"> </span><span class="o">-</span><span class="n">y</span><span class="w"> </span><span class="o">--</span><span class="n">nogpgcheck</span><span class="w"> </span><span class="n">sumo</span><span class="o">-</span><span class="mf">1.25</span><span class="o">.</span><span class="mi">0</span>
</code></pre></div>
...
<ul>
<li>pkg installer: <a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-1.25.0.pkg">sumo-1.25.0.pkg</a><?php getInfo("sumo-1.25.0.pkg","r",false);?></li>
</ul>
...
<ul>
<li><a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-src-1.25.0.tar.gz">sumo-src-1.25.0.tar.gz</a><?php getInfo("sumo-src-1.25.0.tar.gz","r",false);?></li>
<li><a class="no-arrow-link" href="https://sumo.dlr.de/releases/1.25.0/sumo-src-1.25.0.zip">sumo-src-1.25.0.zip</a><?php getInfo("sumo-src-1.25.0.zip","r",false);?></li>
</ul>
...
?>
        ...
        <footer class="col-md-12">
            ...
            <br><small><i>This page was last edited on: 16 October 2025</i></small>
